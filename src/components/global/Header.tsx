...
const Header: FC<props> = ({
    ...
    const navItems = [
        ...
        { name: 'MetaRule', href: '/metarule', children: [{ name: 'Home', href: '/metarule' }, { name: 'Blogs', href: '/metarule/blogs' }, { name: 'Publications', href: '/metarule/publications' }, { name: 'Documents', href: '/metarule/documents/0' }] },
